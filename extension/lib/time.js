 ...
 * @typedef {{days: Number, hours: Number, minutes: Number, seconds: Number,
 *            milliseconds: Number}} ParsedTime
 */

/**
 * An object representing the individual dimensions of an amount of time,
 * plus some alternate representations of that time and a timestamp of when this
 * struct was created.
 * @typedef {{...ParsedTime, formatted: String, raw: Number,
 *            timestamp: Number}} TimeStruct
 */

const TimeUtils = {
  /**
   * Constructs a new TimeStruct with the provided number of milliseconds.
   * @param {Number} [milliseconds = 0] - The value to instantiate this
   * TimeObject with, in milliseconds.
   * @param {Object} options
   * @return {TimeStruct} - A populated TimeStruct object.
   */
   ...
   * @return {ParsedTime} - An object representing each dimension of the time.
   */
   ...
   * @return {number} - The parsed time string represented as milliseconds.
   */
